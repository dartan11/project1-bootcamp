...
export default class Multiplication extends React.Component {
  ...
  questionGenerator = () => {
    ...
    for (let i = 0; i < 10; i++) {
      let number1 = Math.ceil(Math.random() * 4) + 1
      let number2 = Math.ceil(Math.random() * 4) + 1
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (this.state.numberOfCorrect !== prevState.numberOfCorrect) {
      ...
      for (let i = 0; i < this.state.numberOfCorrect; i++) {
        ...
        let newUserPoints = userDetails.points + 20
    ...
    return (
      <div className="App">
        <div className="Category-header">
          <Row>
            <Col className="fontchange">Multiplication</Col>
          </Row>
          <br />
          <Row>
          ...
          <Row>
            <Col className="fontchange">Answer all questions and click submit, <br />you will earn 20 points for every correct answer!</Col>
          </Row>
          <br />
          <Row>
            <Col>
          ...
          <br />
          <Row>
            {this.state.disableButtons === true ? <div>You answered {this.state.numberOfCorrect} out of 10 questions correctly, you've earned {this.state.numberOfCorrect * 20} points! <br /> Click on the button below to select a new category!<br /><br /></div> : null}
          </Row>
