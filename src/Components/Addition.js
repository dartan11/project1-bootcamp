...
export default class Addition extends React.Component {
  ...
  questionGenerator = () => {
    ...
    for (let i = 0; i < 10; i++) {
      let number1 = Math.ceil(Math.random() * 9) + 10
      let number2 = Math.ceil(Math.random() * 9) + 10
    ...
    return (
      <div className="App">
        <div className="Category-header">
          <Row>
            <Col className="fontchange">Addition</Col>
          </Row>
          <br />
          <Row>
          ...
          <br />
          <Row>
            {this.state.disableButtons === true ? <div>You answered {this.state.numberOfCorrect} out of 10 questions correctly, you've earned {this.state.numberOfCorrect * 10} points! <br /> Click on the button below to select a new category!<br /><br /></div> : null}
          </Row>
